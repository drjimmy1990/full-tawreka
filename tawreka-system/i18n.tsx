...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'analytics.charts.category_sales': 'مبيعات الأقسام',
    'common.currency': 'ج.م',
    ...
    'filter.active': 'نشط',
    'filter.all_payments': 'كل المدفوعات',
    'checkout.cash': 'نقدي',
    'checkout.card': 'بطاقة',
    // Menu Builder
    'nav.menu_builder': 'إدارة القائمة',
    'nav.branch_prices': 'أسعار الفروع',
    'nav.site_settings': 'إعدادات الموقع',
    'menu.categories': 'الأقسام',
    'menu.items': 'أصناف القائمة',
    'menu.add_item': 'إضافة صنف',
    'menu.edit_item': 'تعديل الصنف',
    'menu.new_item': 'صنف جديد',
    'menu.new_category': 'قسم جديد',
    'menu.edit_category': 'تعديل القسم',
    'menu.name_ar': 'الاسم (عربي)',
    'menu.name_en': 'الاسم (إنجليزي)',
    'menu.description': 'الوصف',
    'menu.price': 'السعر',
    'menu.image_url': 'رابط الصورة',
    'menu.sort_order': 'ترتيب العرض',
    'menu.save': 'حفظ',
    'menu.save_item': 'حفظ الصنف',
    'menu.save_category': 'حفظ القسم',
    'menu.no_categories': 'لا توجد أقسام. اضغط + لإضافة قسم.',
    'menu.no_items': 'لا توجد أصناف في هذا القسم.',
    'menu.select_category': 'اختر قسم من القائمة الجانبية.',
    'menu.no_description': 'لا يوجد وصف',
    'menu.delete_confirm': 'هل أنت متأكد من حذف هذا الصنف؟',
    'menu.error_save': 'خطأ في الحفظ',
    'menu.error_delete': 'خطأ في الحذف',
    'menu.upload': 'رفع',
    'menu.upload_failed': 'فشل رفع الصورة',
    // Branch Prices
    'prices.select_branch': 'اختر الفرع',
    'prices.title': 'أسعار الفروع',
    'prices.subtitle': 'تجاوز الأسعار العامة لفرع محدد',
    'prices.item_name': 'اسم الصنف',
    'prices.base_price': 'السعر الأساسي',
    'prices.branch_price': 'سعر الفرع',
    'prices.availability': 'التوفر',
    'prices.action': 'الإجراء',
    'prices.save': 'حفظ',
    'prices.saving': 'جاري الحفظ...',
    'prices.saved': 'تم الحفظ ✓',
    'prices.custom': 'مخصص',
  ...
  en: {
    ...
    'analytics.charts.category_sales': 'Sales by Category',
    'common.currency': 'EGP',
    'common.minutes': 'min',
    ...
    'filter.all_payments': 'All Payments',
    'checkout.cash': 'Cash',
    'checkout.card': 'Card',
    ...
    // Menu Builder
    'nav.menu_builder': 'Menu Builder',
    'nav.branch_prices': 'Branch Prices',
    ...
    'menu.name_ar': 'Name (Arabic)',
    'menu.name_en': 'Name (English)',
    ...
    'menu.save_category': 'Save Category',
    'menu.no_categories': 'No categories yet. Click + to add one.',
    'menu.no_items': 'No items in this category yet.',
    'menu.select_category': 'Select a category from the left panel.',
    'menu.no_description': 'No description',
    'menu.delete_confirm': 'Are you sure you want to delete this item?',
    'menu.error_save': 'Error saving',
    'menu.error_delete': 'Error deleting',
    'menu.upload': 'Upload',
    'menu.upload_failed': 'Failed to upload image',
    // Branch Prices
    'prices.select_branch': 'Select Branch',
    'prices.title': 'Branch Menu Pricing',
    'prices.subtitle': 'Overrides global prices for specific location',
    'prices.item_name': 'Item Name',
    'prices.base_price': 'Base Price',
    'prices.branch_price': 'Branch Price',
