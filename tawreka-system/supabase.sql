...
CREATE POLICY "Auth users update orders" ON public.orders FOR
UPDATE TO authenticated USING (true);

CREATE POLICY "Auth users insert orders" ON public.orders FOR
INSERT
    TO authenticated
WITH
    CHECK (true);
...
UPDATE TO authenticated USING (bucket_id = 'menu_images');
